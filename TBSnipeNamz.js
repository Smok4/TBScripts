...
var translations = {
	...
	fr_FR: {
    'Single Village Snipe': 'Snipe Village Unique',
    Help: 'Aide',
    'This script can only be run on a single village screen!':
        'Ce script ne peut être exécuté que depuis l\'écran d\'un village unique !',
    'Landing Time': 'Heure d\'arrivée',
    'Calculate Launch Times': 'Calculer les horaires de lancement',
    'Export as BB Code': 'Exporter en BBCode',
    'Landing time was updated!': 'L\'heure d\'arrivée a été mise à jour !',
    ...
    Status: 'Statut',
    Send: 'Envoyer',
    'Error fetching village groups!': 'Erreur lors du chargement des groupes de villages !',
    'Choose Units to Snipe': 'Choisissez les unités à utiliser pour le snipe',
    Group: 'Groupe',
    'No possible snipe options found!': 'Aucune option de snipe possible trouvée !',
    Distance: 'Distance',
    'An error occured while fetching troop counts!':
        'Une erreur est survenue lors de la récupération des troupes !',
    'snipe attempts found': 'tentatives de snipe trouvées',
    'Nothing to export!': 'Rien à exporter !',
    'Target:': 'Cible :',
    'Send in': 'Envoi dans',
    'Destination Village': 'Village de destination',
    Sigil: 'Sceau',
    'Min. Amount': 'Quantité min.',
    'Export Config': 'Exporter la config',
    'Import Config': 'Importer la config',
    'Configuration imported successfully!':
        'Configuration importée avec succès !',
    'Nothing to import!': 'Rien à importer !',
    'There was an error fetching villages by group!':
        'Erreur lors du chargement des villages par groupe !',
    'Reset Chosen Group': 'Réinitialiser le groupe sélectionné',
    'Chosen group was reset!': 'Le groupe sélectionné a été réinitialisé !',
    'There was an error!': 'Une erreur est survenue !',
    'Configuration has been copied!': 'Configuration copiée !',
    'BBCode have been copied!': 'BBCode copié !',
    'This script requires Premium Account!':
        'Ce script nécessite un compte Premium !',
    'Reset Script': 'Réinitialiser le script',
    'Script configuration has been reset!':
        'La configuration du script a été réinitialisée !',
    'Send in:': 'Envoyer dans :',
    WB: 'BB',
    'Copied Command successfully': 'Ordre copié avec succès',
